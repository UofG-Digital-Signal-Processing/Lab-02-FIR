...
4. Ploting the time domain and frequency domain before and after filtering  
...
![task_4_(Template and Wavelet)](\res\task_4_(Template and Wavelet).svg)
...
![task_4_(R peaks detected)](\res\task_4_(R peaks detected).svg)
...
![task_4_(Output after thresholding)](\res\task_4_(Output after thresholding).svg)
...
![task_4_(Momentary Heartrate_0)](\res\task_4_(Momentary Heartrate_0).svg)
...
![task_4_(Momentary Heartrate)](\res\task_4_(Momentary Heartrate).svg)
